...
@router.get("/{id:int}/", summary="Получить одного пользователя по id")
...
@router.put("/edit-user-full/{user_id:int}/", summary="Редактировать пользователя. Для менеджера и админа")
